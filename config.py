...
TUT_VID = os.environ.get("TUT_VID", "https://t.me/hotousebotes/5") # shareus ka tut_vid he 

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002351708997"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1480923991 5069922547 6695586027 7328629001").split()):
        ADMINS.append(int(x))
except ValueError:
